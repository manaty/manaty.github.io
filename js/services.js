    ...
    $(".service-icons-container .icon").hover(
        function() {
            if (!isMobile) {
                ...
                if($(this).data('title') !== 'Scientific Research' && $(this).data('title') !== 'Recherche Scientifique') {
...
function validate() {
    ...
    if(!$("#fullname").val()) {
        $("#fullnameBlock").removeClass('d-none');
        $("#fullnameBlock").addClass('d-block');
    }
    else {
        $("#fullnameBlock").removeClass('d-block');
    ...
    if(!$("#email").val()) {
        ...
        $("#emailBlock").removeClass('d-block');
